        ...
        children: [
          ...
          ValueListenableBuilder(
              ...
              builder: (context, isLoading, _) => ValueListenableBuilder(
                  ...
                  builder: (context, success, __) => ButtonWidget(text: success ? "SUCCESS" : "REGISTER", icon: success ? Icons.check : null, isLoading: notifyIsLoading.value, onPressed: success ? null : () {
