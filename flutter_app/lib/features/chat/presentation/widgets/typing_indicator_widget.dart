...
import 'package:flutter_group_chat_app_with_firebase/features/chat/presentation/widgets/balloon_widget.dart';
...
class TypingIndicatorWidget extends StatelessWidget {
  ...
  const TypingIndicatorWidget({Key? key, this.showUserInfo, this.margin = EdgeInsets.zero}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                if (showUserInfo != null)
                  ...[
                    Text(showUserInfo!.fullName, style: const TextStyle(fontSize: 14, color: Colors.blue, fontWeight: FontWeight.w600)),
                ...
                const Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 4,),
                    _DotWidget(delayToStart: Duration(milliseconds: 250),),
                    SizedBox(width: 4,),
                    _DotWidget(delayToStart: Duration(milliseconds: 500),),
                  ],
                )
              ],
            )
