...
class MyCustomTextFormField extends StatefulWidget {
  ...
  MyCustomTextFormField({Key? key, this.onSaved, this.keyboardType, this.validator, this.initialValue, this.notifyError, required this.hintText, this.prefixIcon, this.suffixIcon, this.controller, this.obscureText = false,}) : super(key: key);
                ...
                children: [
                  Container(
                    ...
                    child: TextField(
                      ...
                      scrollPadding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom + (inputStyle.fontSize ?? 16) * 5),
